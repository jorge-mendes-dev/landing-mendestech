...
const Home: FC = () => {
  ...
  return (
    <>
      <Seo
        title="Home"
        description="Jorge Mendes - Senior Full Stack Developer with 8 years of experience building scalable web applications using React, TypeScript, and modern JavaScript technologies."
