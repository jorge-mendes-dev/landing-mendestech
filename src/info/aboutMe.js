...
export const aboutSecond = [
  "Thinking about getting to a higher level, I sought a degree, I choose the course on Internet Systems at the Faculty of Technology of São Roque - Fatec, a reference in the region that has high-level professionals and know-how, contributing to a better understanding of the market.",
  "Since I got my colege degree, i moved to São Paulo, one of the greatests citys with a I.T market.",
  "By the time pass, I learned front-end, back-end, data, and infra-structure, as well, and start to develop my projects and systems.",
