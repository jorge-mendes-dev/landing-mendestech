...
const HomeAbout = ({ ...props }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white/95 dark:bg-zinc-900/95 dark:border-zinc-800 backdrop-blur-sm rounded-2xl max-w-lg md:max-w-2xl md:z-10 md:shadow-card-elevated md:absolute md:top-0 md:mt-48 lg:w-3/5 lg:left-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12 border border-white/20 dark:border-gray-800/50">
