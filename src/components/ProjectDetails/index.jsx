    ...
    >
      ...
      <div className="block sm:flex gap-0 sm:gap-10 mt-14">
        <div className="w-full sm:w-1/3 text-left">
          ...
          <LazyShow>
            <div className="mb-7 p-6">
              <h4 className="text-secondary text-2xl font-semibold text-secondary-dark dark:text-secondary-dark mb-2">
          ...
          <LazyShow>
            <div className="mb-7 p-6">
              <h4 className="font-general-regular text-secondary text-2xl font-semibold text-secondary-dark dark:text-secondary-dark mb-2">
