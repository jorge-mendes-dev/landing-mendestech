 ...
 */
interface MendestechNotificationOptions extends NotificationOptions {
  onClick?: () => void
}
...
export function useNotifications(): {
  ...
  sendNotification: (
    title: string,
    body: string,
    options?: MendestechNotificationOptions
  ) => Promise<boolean>
} {
  /**
   ...
   * @param {NotificationOptions} options - Additional notification options
   */
   ...
   * @param {NotificationOptions} options - Notification options (icon, image, badge, vibrate, etc.)
   */
